...
module.exports = welcome = async (tobz, event) => {
    ...
    try {
        if (event.action == 'add' && isWelkom) {
            ...
            const capt = `Selamat Bergabung di *Grup ${name}*\n================\nName : @${event.who.replace('@c.us', '')}\nInfo :  \n================\nSelamat datang su. Nyolot gw kick, ga suka leave aja ga ush berisik. baca deskripsi group ya`
